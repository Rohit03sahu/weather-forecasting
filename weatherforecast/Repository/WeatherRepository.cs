...
namespace weatherforecast.Repository
{
    public class WeatherRepository : IWeatherRepository
    {
        ...
        public async Task<HttpResponseMessage> FetchWeatherDetailsByLocations(string location, string timeLine)
        {
            ...
            var response = await client.GetAsync($"{_appSettings.WeatherApiEndpoint}?location={location}&fields=temperature&timesteps={timeLine}&unit=metric&apikey={_appSettings.WeatherApiKey}");
